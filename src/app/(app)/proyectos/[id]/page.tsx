...
import { canEditProjects, canDeleteProject, canEditFinancialTabs, canDownloadReport, canCreateModification } from "@/modules/projects/lib/access"
  ...
  return (
    <div className="space-y-0">
      ...
      <InteradministrativoDetail
        ...
        canModify={canCreateModification(profile?.role)}
