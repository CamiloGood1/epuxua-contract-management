...
export default async function ContratosDerivadosPage() {
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground leading-tight">
              Gestión de Contratos Derivados
            </h1>
            <p className="text-sm text-muted-foreground mt-1 max-w-xl">
              Administración centralizada de contratos derivados de convenios
              interadministrativos o contratos marco operativos para la ejecución del plan de acción.
            </p>
          </div>
        </div>

        <button className="flex items-center gap-2 px-4 py-2 bg-[var(--corporate-blue)] text-white rounded-xl text-sm font-medium hover:opacity-90 transition-opacity shadow-sm shrink-0">
          <Download size={15} />
          Descargar Excel
        </button>
      </div>

      {/* Client: KPIs + filtros + tabla */}
