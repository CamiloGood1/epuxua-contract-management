...
FROM (VALUES
  ...
  ('contratos DIRECTO',        (SELECT COUNT(*) FROM contracts WHERE contract_type = 'DIRECTO')::int,              617),
  ...
  ('contratos con padre',      (SELECT COUNT(*) FROM contracts WHERE parent_contract_id IS NOT NULL)::int,         169),
